    ...
    >
      <div className="mx-auto w-full max-w-[1320px]">
        <div className="mb-10 flex flex-col gap-8 md:mb-12 md:flex-row md:items-center md:justify-between">
          <FadeUp>
            <div>
              <span className="mb-6 inline-flex text-[#ff5100] rounded-full bg-white px-8 py-2 text-base font-semibold shadow-sm">
                Reviews
              </span>
              <h2
                className="leading-[1.1] tracking-tight text-[#1e1e1e]"
                style={{ fontSize: "clamp(1.5rem, 4vw, 3rem)", fontFamily: "Poppins, sans-serif" }}
              >
                <span className="text-[#ff5100] font-black">30,000+</span>{" "}
                <span className="font-black text-[#1E1E1E]">Happy Buyers</span>
              </h2>
              <p className="text-base md:text-lg leading-relaxed text-[#555] font-medium lg:text-left md:mt-12 md:max-w-[380px]">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          {reviews.map((review, i) => (
            <FadeUp key={review.id} delay={i * 0.12}>
              <article className="flex flex-col justify-between border border-white bg-white p-7 shadow-sm transition-shadow hover:shadow-md h-full">
                <div>
                  <span className="mb-4 block font-serif text-[50px] font-black leading-none text-[#1e1e1e]">
                    "
                  </span>
                  <p className="mb-8 text-[18px] leading-relaxed text-[#484848] font-medium">
                    {review.text}
                  </p>
                </div>
                <div className="flex items-end justify-between mt-auto">
                  <div className="flex flex-col gap-2">
                    ...
                    <h3 className="text-[16px] font-semibold text-[#1e1f20]">
                      {review.name}
                    </h3>
                  </div>
                  <img
